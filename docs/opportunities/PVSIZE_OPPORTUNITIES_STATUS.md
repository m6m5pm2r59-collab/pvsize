...
`9d8ed27 Add fifth opportunities detail baseline`
...
Continue Phase 5C Publication Pipeline: perform a local static-server HTTP check for `/opportunities/` plus all five generated detail pages, then record evidence. Do not add sitemap/RSS/newsletter or mark Phase 5C Closed until production verification evidence exists.
