...
- PV source-of-truth workspace: `/pv`
- Transitional root compatibility links may still exist for deployment and script stability.
- KR1688 must stay isolated under `/kr1688`.
...
- 当前 Vercel 项目 rootDirectory 仍指向仓库根兼容入口 `src`
