...
const steps = [
  ...
  ['Published record preflight matrix verification', ['src/tools/verify-opportunities-published-record-preflight-matrix.js', '--self-test'], {}],
  ['Indexed output activation preflight matrix verification', ['src/tools/verify-opportunities-indexed-output-activation-preflight-matrix.js', '--self-test'], {}],
  ...
  ['Phase 5C pre-implementation long-run board verification', ['src/tools/verify-opportunities-phase5c-pre-implementation-long-run-board.js', '--self-test'], {}],
